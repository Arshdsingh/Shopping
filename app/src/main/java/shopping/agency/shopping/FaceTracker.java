...
private  int imagedrawable;
  ...
  FaceTracker(GraphicOverlay overlay, Context context, boolean isFrontFacing, int imagedrawable) {
    mOverlay = overlay;
    mContext = context;
  ...
  public void onNewItem(int id, Face face) {
    mFaceGraphic = new FaceGraphic(mOverlay, mContext, mIsFrontFacing,imagedrawable);
  }
