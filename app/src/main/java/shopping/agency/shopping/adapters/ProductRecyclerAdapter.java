...
public class ProductRecyclerAdapter extends RecyclerView.Adapter<ProductRecyclerAdapter.MenuRecyclerAdapterView> {
    Context context;
    LinkedList<ProductItem> linkedList;
    FirebaseStorage storage = FirebaseStorage.getInstance();

    public ProductRecyclerAdapter(Context context, LinkedList<ProductItem> linkedList)
    {
...
holder.remove.setOnClickListener(new View.OnClickListener() {
    ...
    holder.delete.setOnClickListener(new View.OnClickListener() {
        ...
        if(holder.title.getText().toString().contains("hat"))
        {
            holder.imageView2.setImageResource(R.drawable.hat);
        }
        else   if(holder.title.getText().toString().contains("hat"))
        {
